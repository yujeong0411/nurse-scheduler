...
근무 7종: D, D9, D1, 중1, 중2, E, N
  - D: 주간 / D9·D1·중1·중2: 중간(입력전용: D9·D1·중1, 솔버배정: 중2) / E: 저녁 / N: 야간
...
# 근무 코드 (D9·D1·중1은 입력 전용, 솔버 자동배정 없음)
...
# D(1) → D9/D1/중1/중2(2) → E(3) → N(4)
SHIFT_ORDER = {
    "D": 1,
    "D9": 2, "D1": 2, "중1": 2, "중2": 2,  # 중간 계열
    "E": 3,
    "N": 4,
}
