      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 py-16">
        ...
        <div className="text-center mb-10">
          ...
          {settings?.department_name && (
            <p className="text-blue-300 text-sm md:text-base font-semibold">{settings.department_name}</p>
          )}
        </div>
        ...
        {!loading && startDate && (
          <div className="w-full max-w-sm md:max-w-md mb-8 rounded-2xl p-4 md:p-6"
            ...
            <p className="text-white font-bold text-lg md:text-2xl text-center mb-3">
              {fmtDate(startDate)} ~ {endStr}
            </p>
            {deadline && (
              <div className={`flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-sm md:text-base font-semibold ${passed
        ...
        <div className="w-full max-w-sm md:max-w-md space-y-3">
          <button
            ...
            className="w-full bg-white text-blue-700 font-bold text-lg md:text-xl rounded-2xl py-5 md:py-6 flex items-center justify-center gap-3 active:scale-95 transition-all shadow-2xl hover:bg-blue-50 hover:scale-[1.02]"
          >
          ...
          <button
            ...
            className="w-full text-white font-semibold text-lg md:text-xl rounded-2xl py-4 md:py-5 flex items-center justify-center gap-2 active:scale-95 transition-all hover:scale-[1.02] hover:brightness-125"
