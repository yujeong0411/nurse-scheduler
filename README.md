...
| 항목 | 가중치 | 설명 |
|------|--------|------|
| S1 희망 요청 반영 | **A: +800+score×5 / B: +500+score×15** | 간호사 근무·휴무 신청 반영. A조건 월 3개 제한, B는 score 100일 때 최대 2000 |
| S1a OR 요청 | 동일 공식 | `D/휴가` 형태 — 둘 중 하나라도 맞으면 보상 |
