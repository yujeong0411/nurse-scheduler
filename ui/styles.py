...
SHIFT_COLORS = {
    # 입력 전용 중간근무
    "D9":  QColor(180, 225, 232),
    "D1":  QColor(180, 225, 232),
    "중1":  QColor(253, 235, 208),
    # 휴무 (10종)
...
SHIFT_TEXT_COLORS = {
    "D9": QColor(46, 117, 182),
    "D1": QColor(46, 117, 182),
    "중1": QColor(191, 143, 0),
    "N": QColor(214, 21, 6),
    # "OFF": QColor(214, 21, 6),
    # "주": QColor(214, 21, 6),
...
# 요청사항 탭 코드 (빈칸 = 자동배정, D9·D1·중1은 입력 전용 중간근무)
REQUEST_CODES = [
    "", "D", "D9", "D1", "중1", "중2", "E", "N",
    "OFF", "주", "법휴", "생휴", "수면", "휴가", "병가", "특휴", "공가", "경가", "보수", "필수", "번표",
    "D 제외", "E 제외", "N 제외",
]
...
SHIFT_TYPES = [
    "D", "D9", "D1", "중1", "중2", "E", "N",
    "OFF", "주", "법휴", "생휴", "수면", "POFF", "휴가", "병가", "특휴", "공가", "경가", "보수", "필수", "번표",
]
